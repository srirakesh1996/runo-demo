...
function submitForm(formId, formData, formToken) {
    ...
    try {
        fetch(
            "https://script.google.com/macros/s/AKfycbwgPwdbDumSUOfUOv2tOj3i9QzQekzbmt7BLOJ8seLs2t4QwtDooMrjUumpCY3epg6xfg/exec",
            { method: "POST", mode: "no-cors", body: JSON.stringify(sheetData), keepalive: !0 }
        );
    } catch (e) {}
    $.ajax({
        type: "POST",
